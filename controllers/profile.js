    ...
    return {
        ...
        getProfilePage: function(req, res) {
            ...
            async.parallel([
                ...
                res.render('user/profile', {title: 'Assemble - Profile', user: req.user, data: result1, chat: result2});
            });
        ...
        postProfilePage: function(req, res) {
            ...
            // in waterfall the result of the first function is passed to second funtion
            async.waterfall([
                function(callback) {
        ...
        overviewPage: function(req, res) {
            async.parallel([
              ...
              res.render('user/overview', {title: 'Assemble - Overview', user: req.user, data: result1, chat: result2});
          });
        },
