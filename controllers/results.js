    ...
    return {
        ...
        postResults: function(req, res) {
            async.parallel([
                ...
                res.render('results', {title: 'Assemble - Results', user: req.user, chunks: dataChunk});
            });
        },
        ...
        viewMembers: function(req, res) {
            ...
            async.parallel([
                ...
                res.render('members', {title: 'Assemble - Members', user: req.user, chunks: dataChunk});
            });
        },
        ...
        searchMembers: function(req, res) {
            async.parallel([
                function(callback) {
                    const regex = new RegExp((req.body.username), 'gi'); // gi - globally ignoring case
