module.exports = function(Users, async, Message, FriendResult, Group) {
    return {
        ...
        groupPage: function(req, res) {
            ...
            // funtions for sending the friend request
            async.parallel([
                function(callback) {
                    Users.findOne({
                ...
                res.render('groupchat/group', {title: 'Assemble - Group', user: req.user,  groupName:name, data: result1, chat: result2, groupMsg: result3});
            });
        },
